...
router.get("/search-in-all-users", Validator.forFeature(AdminReqValidator.SearchQuery), AdminController.default.searchUsers)
router.get("/get-single-user/:user_id",Validator.forFeature(AdminReqValidator.UserIdParam), AdminController.default.getUser)
