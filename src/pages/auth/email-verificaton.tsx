...
const EmailVerificaton = ({
  email,
  type
}: { email: string, type: "verfication" | "reset" }) => {
  return (
            ...
            <div className="bg-white shadow-md text-center p-6 rounded-s col-span-6">
              ...
              {type === "verfication" ? (<>
                ...
                <p className="text-gray-500 text-sm font-medium">
                  ...
                  <p className="text-gray-500 text-sm font-medium mb-6">
                    We sent a Password Resset link to you at{" "}
                    <span className="text-gray-800 fw-medium">
                      {email}
                    </span>
                  </p>
                  <p className="text-gray-500 text-sm font-medium">
                    Simply click on the link available in the  Link to reset your
                    password.
                  </p>
                </>)}
...
export default EmailVerificaton