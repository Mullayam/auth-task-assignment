...
const LeftSidbar = ({ open ,user}: { open: boolean,user:IUser }) => {
    return (
        <aside
        className={`fixed top-0 left-0 z-20 flex flex-col pt-16 flex-shrink-0 h-full border-r border-gray-200 dark:border-gray-700 duration-300  transition-width transition-transform ${
            !open ? "xtranslate-x-0" : "-translate-x-full"
          } lg:translate-x-0 lg:w-64 md:w-60 ${
            open ? "lg:w-64 md:w-60" : "lg:w-14 md:w-14"
